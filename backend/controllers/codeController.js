...
export const submitCode = async (req, res) => {
    ...
    try {
        ...
        // --- FIX: Reverted to a sequential for...of loop for stability and consistency ---
        for (const testCase of problem.testCases) {
            try {
                ...
                // If a single test case fails to execute, we skip it and move on.
                // This is logged on the server but not sent to the user.
