...
// utils/codeGenUtils.js
/**
 * Improved type detection and JS->Java type mapping.
 * - detectType inspects nested arrays and objects (to a reasonable depth).
 * - parseInputToTypes tries to parse the input into real JS values (wrapped in []),
 *   and returns an array of type signatures (e.g. "number", "string[]", "number[][]", "object").
 * - mapJsTypeToJava provides safe mapping for common types and falls back to Object.
 */
